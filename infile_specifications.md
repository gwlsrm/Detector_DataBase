...
## 7. Список параметров расчёта

- low_energy_threshold - не считать рассеенное излучение для линий с энергией ниже этого порога (в МэВ)
- pair_peaks_threshold - для гамма-линий с энергией ниже порога не считать эффективности пиков одинарной и двойной утечки
- xray_escape_threshold - пики рентгеновской утечки рассчитываются только энергий ниже этого порога
- photon_LEcutoff - заканчивать историю фотона в Монте-Карло, если его энергия упала ниже этого порога
- electron_LEcutoff - заканчивать историю электрона в Монте-Карло, если его энергия упала ниже этого порога
- phys_spectrum_Emax - максимальная энергия в спектре
- phys_spectrum_dE - ширина канала в спектре
- useGLECS - использовать приближение GLECS для расчёта рассеяния фотонов
- useEPDL97 - использовать библиотеку EPDL97 в М.-К.
- calc_electron_ttb - вкючить электронный транспорт в приближении TTB
- calc_electron_real - включить реальный электронный транспорт
- xrays - вкючить учёт рентгеновских линий
- annihilation - включить учёт анигиляционных линий
- angular - включить угловую корреляция испускаемых гамма-квантов
- angle_optimize - испускать гамма-кванты только в телесном угле детектора
- calc_full_eff - считать полную эффективность
- calc_spectrum - считать спектр
- calc_coincidence - считать поправки на истинное суммирование
- calc_scattered - учитывать рассеянное излучение
- use_exp_transform - включить экспоненциальную оптимизацию расчёта
- exp_transform_p_parameter - параметр экспоненциальной оптимизации
